...
data class MessageOptions(
     ...
     * value is not set (null), which means the [QueueOptions.defaultDelay][kolbasa.queue.QueueOptions.defaultDelay] will be used.
     *
    ...
    /**
     * Default queue consume attempts before message will be expired or moved to DLQ. By default, value is not set (null),
    ...
    companion object {
        internal val NOT_SET = MessageOptions()
