...
data class MetaValues(val values: List<MetaValue<*>>) {
    ...
    companion object {
        val EMPTY = of(emptyList<MetaValue<*>>())
...
internal data class ByteValue(override val field: MetaField<Byte>, override val value: Byte) : MetaValue<Byte>(field, value)
internal data class ShortValue(override val field: MetaField<Short>, override val value: Short) : MetaValue<Short>(field, value)
internal data class IntValue(override val field: MetaField<Int>, override val value: Int) : MetaValue<Int>(field, value)
internal data class LongValue(override val field: MetaField<Long>, override val value: Long) : MetaValue<Long>(field, value)
