...
interface ConnectionAwareInspector {
     ...
     */
    fun size(connection: Connection, queue: Queue<*>): Long
     ...
     */
    fun isEmpty(connection: Connection, queue: Queue<*>): Boolean
     ...
     */
    fun isDeadOrEmpty(connection: Connection, queue: Queue<*>): Boolean
