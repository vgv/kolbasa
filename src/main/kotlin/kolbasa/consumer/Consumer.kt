...
interface Consumer<Data, Meta : Any> {
    ...
    fun receive(filter: () -> Condition<Meta>): Message<Data, Meta>?
    fun receive(receiveOptions: ReceiveOptions<Meta>): Message<Data, Meta>?

    fun receive(limit: Int): List<Message<Data, Meta>>
    fun receive(limit: Int, filter: () -> Condition<Meta>): List<Message<Data, Meta>>
...
interface ConnectionAwareConsumer<Data, Meta : Any> {
    ...
    fun receive(connection: Connection, filter: () -> Condition<Meta>): Message<Data, Meta>?
    ...
    fun receive(connection: Connection, limit: Int, filter: () -> Condition<Meta>): List<Message<Data, Meta>>
