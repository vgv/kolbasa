    ...
    private fun forTable(queue: Queue<*>, existingTable: Table?, mutableSchema: MutableSchema, idRange: IdRange) {
        val createTableStatement = """
            create table if not exists ${queue.dbTableName}(
                ...
                ${Const.CREATED_AT_COLUMN_NAME} timestamptz not null default statement_timestamp(),
                ${Const.SCHEDULED_AT_COLUMN_NAME} timestamptz not null default clock_timestamp(),
                ${Const.PROCESSING_AT_COLUMN_NAME} timestamptz,
