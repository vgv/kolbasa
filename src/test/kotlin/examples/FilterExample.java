...
class FilterExample {
    ...
    public static void main(String[] args) {
        ...
        // The Kotlin twin of this example passes the same filter as a lambda; from Java the filter is
        // built with the type-safe static factories of `Filter` and handed over in ReceiveOptions.
